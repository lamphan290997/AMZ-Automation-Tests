...
describe('Vehicle Type CV', () => {
  it('Submit Check Required', () => {
    /*Check Vehicle Type*/
    cy.get('#VEHICLE_TYPE > :nth-child(2)')
    .click()
    .wait(3000);
   ...
   /*OVERALL CONDITION*/
    ...
    /*Passenger Area*/
    /*Is seat belt free of damage?*/
    cy.get(':nth-child(15) > .ant-collapse-content > .ant-collapse-content-box > :nth-child(1) > .ant-row-center > .ant-col-xs-24 > .ant-row > .ant-col > .ant-form-item-explain > div')
    .contains('Please answer this question!');

    /*Does seat belt properly buckle?*/
    cy.get(':nth-child(15) > .ant-collapse-content > .ant-collapse-content-box > :nth-child(2) > .ant-row-center > .ant-col-xs-24 > .ant-row > .ant-col > .ant-form-item-explain > div')
    .contains('Please answer this question!');

    /*Is driver seat free of damage?*/
    cy.get(':nth-child(15) > .ant-collapse-content > .ant-collapse-content-box > :nth-child(3) > .ant-row-center > .ant-col-xs-24 > .ant-row > .ant-col > .ant-form-item-explain > div')
    .contains('Please answer this question!');

    /*Is area clean? */
    cy.get(':nth-child(15) > .ant-collapse-content > .ant-collapse-content-box > :nth-child(4) > .ant-row-center > .ant-col-xs-24 > .ant-row > .ant-col > .ant-form-item-explain > div')
    .contains('Please answer this question!');

    /*Are the interiors free of any obvious damage?*/
    cy.get(':nth-child(15) > .ant-collapse-content > .ant-collapse-content-box > :nth-child(5) > .ant-row-center > .ant-col-xs-24 > .ant-row > .ant-col > .ant-form-item-explain > div')
    .contains('Please answer this question!');

    /*Is the cabin free of any smoke odors?*/
    cy.get(':nth-child(15) > .ant-collapse-content > .ant-collapse-content-box > :nth-child(6) > .ant-row-center > .ant-col-xs-24 > .ant-row > .ant-col > .ant-form-item-explain > div')
    .contains('Please answer this question!');
    ...
    cy.get(':nth-child(17) > .ant-collapse-content > .ant-collapse-content-box > :nth-child(2) > .ant-row-center > .ant-col-xs-24 > .ant-row > .ant-col > .ant-form-item-explain')
    .contains('Please answer this question!');

    /*Is the area clean? */
    cy.get(':nth-child(17) > .ant-collapse-content > .ant-collapse-content-box > :nth-child(3) > .ant-row-center > .ant-col-xs-24 > .ant-row > .ant-col > .ant-form-item-explain > div')
    .contains('Please answer this question!');        

    /*Are interior lights operational?*/
    cy.get(':nth-child(17) > .ant-collapse-content > .ant-collapse-content-box > :nth-child(4) > .ant-row-center > .ant-col-xs-24 > .ant-row > .ant-col > .ant-form-item-explain > div')
    .contains('Please answer this question!');   

    /*Is wheel dolly present?*/
    cy.get(':nth-child(17) > .ant-collapse-content > .ant-collapse-content-box > :nth-child(5) > .ant-row-center > .ant-col-xs-24 > .ant-row > .ant-col > .ant-form-item-explain > div')
    .contains('Please answer this question!');  

    /*Is spare tire present? (SV/CDV only)*/
    cy.get(':nth-child(17) > .ant-collapse-content > .ant-collapse-content-box > :nth-child(6) > .ant-row-center > .ant-col-xs-24 > .ant-row > .ant-col > .ant-form-item-explain > div')
    .contains('Please answer this question!');  
    ...
    cy.get(':nth-child(21) > .ant-collapse-content > .ant-collapse-content-box > .sc-iklJeh > .ant-row-center > .ant-col-xs-24 > .ant-row > .ant-col > .ant-form-item-explain > div')
    .contains('Please answer this question!');
  });
  ...
  it('Select Full NO', () => {
   ...
   /*Is license plate installed? (If applicable)*/
    ...
    cy.get('#ROLLUP_DOOR_IS_DOOR_OPERATIONAL_CV_CDV_ONLY > :nth-child(2)')
    .click();/*NO*/
    ...
    cy.get('#ROLLUP_DOOR_IS_DOOR_OPERATIONAL_CV_CDV_ONLY > :nth-child(3) > :nth-child(2)');/*NA*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(11) > div.ant-collapse-content.ant-collapse-content-active > div > div > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(12) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(1) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(12) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(2) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(12) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(3) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(13) > div.ant-collapse-content.ant-collapse-content-active > div > div > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(7) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(8) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(9) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(10) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(11) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(12) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(13) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(14) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(15) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(5) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(15) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(6) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(15) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(4) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    cy.contains("Is area clean?");  
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(17) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(1) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(17) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(2) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(17) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(3) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(17) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(4) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(17) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(5) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    cy.get('#CARGO_AREA_IS_SPARE_TIRE_PRESENT_CDV_SV_ONLY > :nth-child(2)')
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(17) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(6) > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    cy.get('#CARGO_AREA_IS_SPARE_TIRE_PRESENT_CDV_SV_ONLY > :nth-child(3)');/*NA*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(18) > div.ant-collapse-content.ant-collapse-content-active > div > div > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
    ...
    .click();/*NO*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(21) > div.ant-collapse-content.ant-collapse-content-active > div > div > div.ant-row.ant-form-item > div > div > div > span > div > div > span > input[type=file]')
    .attachFile('amz.jpg',{
    Force: true,
    }).wait(1000);/*UploadImg*/
...
it('Reload Check Behavior', () => {
   ...
   /*Is license plate installed? (If applicable)*/
    ...
    /*Roll-Up Door*/
    /*Is door operational? (CV/CDV only)*/
    cy.get('#ROLLUP_DOOR_IS_DOOR_OPERATIONAL_CV_CDV_ONLY > label.ant-radio-button-wrapper.ant-radio-button-wrapper-checked > span.ant-radio-button.ant-radio-button-checked > input')
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(10) > div.ant-collapse-content.ant-collapse-content-active > div > div > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');    
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(12) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(2) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');      
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(12) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(3) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');     
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(7) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');  
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(8) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible'); 
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(10) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');  
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(11) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');  
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(12) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible'); 
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(14) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(13) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible'); 
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(15) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(1) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible'); 
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(15) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(5) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');  
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(15) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(6) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible'); 
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(15) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(2) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');  
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(15) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(3) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');  
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(15) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(4) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');  
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(17) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(1) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');  
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(17) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(2) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');   
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(17) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(3) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');   

    /*Are interior lights operational?*/
    cy.get('#CARGO_AREA_IS_THE_AREA_CLEAN > label.ant-radio-button-wrapper.ant-radio-button-wrapper-checked > span.ant-radio-button.ant-radio-button-checked > input')
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(17) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(4) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');     
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(17) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(5) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');   
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(17) > div.ant-collapse-content.ant-collapse-content-active > div > div:nth-child(6) > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');   
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(18) > div.ant-collapse-content.ant-collapse-content-active > div > div > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');   
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(20) > div.ant-collapse-content.ant-collapse-content-active > div > div > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible');   
    ...
    .should('have.value','No');/*YES*/
    cy.get('#disclosure > div > form > div.ant-collapse.ant-collapse-icon-position-right > div:nth-child(21) > div.ant-collapse-content.ant-collapse-content-active > div > div > div.ant-row.ant-form-item > div > div > div > span > div > div.ant-upload-list-picture-card-container > div')
    .should('be.visible'); 
